...
public class SerializerUnitTest extends TestCase {
	...
	public void testFlatObjectWithInboundClass() throws Throwable {
		Person person = new Person("John Doe");
		assertEquals("{\"class\":\"js.tools.commons.json.SerializerUnitTest$Person\",\"name\":\"John Doe\",\"state\":\"ALIVE\"}", exerciseWithClass(person));
	}

	public void testArrayOfStrings() throws Throwable {
		String[] strings = new String[] { "John Doe", "picture.png" };
	...
	/** Anonymous inner class has synthetic 'this$0' field for outer class. This should not be included into serialized object. */
	...
	private static String exercise(Object value) throws Throwable {
		Object serializer = Classes.newInstance("js.tools.commons.json.Serializer");
		StringWriter writer = new StringWriter();
		Classes.invoke(serializer, "serialize", writer, value);
		return writer.toString();
	}

	private static String exerciseWithClass(Object value) throws Throwable {
		Object serializer = Classes.newInstance("js.tools.commons.json.Serializer", true);
		StringWriter writer = new StringWriter();
		Classes.invoke(serializer, "serialize", writer, value);
		return writer.toString();
	}
